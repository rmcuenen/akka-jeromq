 ...
 */
public class RecoveryInterval implements SocketOption {

    public static RecoveryInterval create(long value) {
        return new RecoveryInterval(value);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RecoveryInterval) {
            RecoveryInterval that = (RecoveryInterval) obj;
    ...
    public String toString() {
        return String.format("RecoveryInterval(%d)", value);
    }
